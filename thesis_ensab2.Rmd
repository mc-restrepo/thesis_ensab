...
* 1 years old: Any sign of caries is severe ECC
* 3 years old: 
...
examen13 <- examen13 %>%
  mutate(score53_63 = rowSums(across(c(score53, score52, score51, score61, score62, score63)))) %>%
  mutate(cariessev = case_when(
    age == 3 & (score53_63 > 0 | dmft_ICDAS >= 4) ~ 1,
    age == 1 & dmft_ICDAS > 0 ~ 1,
    TRUE ~ 0
  )) %>%
...
This means:
A value of greater than or equal to 1 of the sum of score53, score52, score51, score61, score62, score63
OR dmft_ICDAS greater than or equal to 6
...
ensab <- ninos %>%
  ...
  dplyr::select(-ID_HOGAR.x, -ID_HOGAR.y, -dmft.x, -dmft.y, cariessev.x, cariessev.y, -dmft_ICDAS.x, -dmft_ICDAS.y, -cariesexp.x, -cariesexp.y)
